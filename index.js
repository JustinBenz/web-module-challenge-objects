...
createMenuItem('Dulce De Leche', 50, 'Dessert');
...
*/
let nReviews = reviews.push({name: "Justin", rating: 10, feedback: "Most beautiful human being ever to exist, a god among men"})
console.log(reviews)
